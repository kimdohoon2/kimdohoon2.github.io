...
1. SVG 생성
   ...
   - 그래서 Figma를 사용해 대한민국 국기를 직접 제작하고, SVG로 변환하여 최적화된 형태로 준비했습니다.
     <div>    
     <img src="https://github.com/user-attachments/assets/1738f07f-8ac9-4adc-92b0-3a877b9263c7" width="50%" />
     </div>
...
3. 기술적 인사이트: SVG의 `getTotalLength()` 메서드와 `strokeDasharray`, `strokeDashoffset` 속성을 활용한 애니메이션 기법을 통해 복잡한 도형을 쉽게 애니메이션화할 수 있음을 배웠습니다.
   ...
   ![-Chrome2025-03-2514-03-25-ezgif com-video-to-gif-converter](https://github.com/user-attachments/assets/3f8592d5-2215-4baf-a29a-a45e49a28fa0)
